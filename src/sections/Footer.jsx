    ...
    return (
        <footer className="w-full px-7 md:px-14 lg:px-16 xl:px-24 xxl:px-[120px] bg-dark">
            <section className="w-full font-roboto justify-between pb-[42px] font-medium text-xl
                grid grid-cols-[auto] md:grid-cols-[auto_auto] lg:grid-cols-[auto_auto_auto_auto] leading-[24px]"
            >
            ...
            >
                <p className="text-[32px] translate-y-[2px] pt-2 -pb-2 leading-6">&copy;</p>
